...
//! Rust DABAC LSM, formula level caching with hashing variant (FLCH).
//!
...
mod bindings;
#[path = "formula_level_caching/bindings_mx_flch.rs"]
...
mod helpers;
mod pap;
#[path = "formula_level_caching/pdp_flch.rs"]
mod pdp;
mod pip;
mod policy;
...
const NAME: &CStr = c_str!("dabac_rs_mx_flch");

/// The ID of the LSM in the kernel
const LSM_ID: u64 = kernel::bindings::LSM_ID_DABAC_RS_MX_FLCH as _;
