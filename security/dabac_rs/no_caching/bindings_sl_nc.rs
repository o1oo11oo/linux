...
//! Variant-dependant bindings for Rust DABAC LSM (SL-NC).
//!
...
#[no_mangle]
unsafe extern "C" fn dabac_rs_sl_nc_read_user_attr(
...
#[no_mangle]
unsafe extern "C" fn dabac_rs_sl_nc_update_user_attr(
    _file: *mut bindings::file,
    ptr: UserPtr,
    length: c_ulong,
...
/// May only be used as `read` function pointer in `struct file_operations`
#[no_mangle]
unsafe extern "C" fn dabac_rs_sl_nc_read_object_attr(
    _file: *mut bindings::file,
    ptr: UserPtr,
    count: c_ulong,
    offset: *mut c_longlong,
...
/// May only be used as `write` function pointer in `struct file_operations`
#[no_mangle]
unsafe extern "C" fn dabac_rs_sl_nc_update_object_attr(
    _file: *mut bindings::file,
    ptr: UserPtr,
    length: c_ulong,
    _offset: *mut c_longlong,
...
/// May only be used as `read` function pointer in `struct file_operations`
#[no_mangle]
unsafe extern "C" fn dabac_rs_sl_nc_read_env_attr(
    _file: *mut bindings::file,
    ptr: UserPtr,
    count: c_ulong,
    offset: *mut c_longlong,
...
/// May only be used as `write` function pointer in `struct file_operations`
#[no_mangle]
unsafe extern "C" fn dabac_rs_sl_nc_update_env_attr(
    _file: *mut bindings::file,
    ptr: UserPtr,
    length: c_ulong,
    _offset: *mut c_longlong,
...
/// May only be used as `read` function pointer in `struct file_operations`
#[no_mangle]
unsafe extern "C" fn dabac_rs_sl_nc_read_policy(
    _file: *mut bindings::file,
    ptr: UserPtr,
    count: c_ulong,
    offset: *mut c_longlong,
...
/// May only be used as `write` function pointer in `struct file_operations`
#[no_mangle]
unsafe extern "C" fn dabac_rs_sl_nc_update_policy(
    _file: *mut bindings::file,
    ptr: UserPtr,
    length: c_ulong,
    _offset: *mut c_longlong,
...
/// May only be used as `read` function pointer in `struct file_operations`
#[no_mangle]
unsafe extern "C" fn dabac_rs_sl_nc_read_perf(
    _file: *mut bindings::file,
    ptr: UserPtr,
    count: c_ulong,
    offset: *mut c_longlong,
...
/// May only be used as `write` function pointer in `struct file_operations`
#[no_mangle]
unsafe extern "C" fn dabac_rs_sl_nc_register_perf(
    _file: *mut bindings::file,
    ptr: UserPtr,
    length: c_ulong,
    _offset: *mut c_longlong,
