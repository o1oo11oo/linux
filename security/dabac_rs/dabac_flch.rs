...
mod bindings;
#[path = "formula_level_caching_hashing/bindings.rs"]
mod bindings_variants;
mod epp;
mod expr;
mod helpers;
mod pap;
#[path = "formula_level_caching_hashing/pdp.rs"]
mod pdp;
mod pip;
mod policy;
...
const NAME: &CStr = c_str!("dabac_rs_flch");

/// The ID of the LSM in the kernel
const LSM_ID: u64 = kernel::bindings::LSM_ID_DABAC_RS_FLCH as _;
