...
#define ABAC_RULES_ENABLED 1,
#else
#define ABAC_RULES_ENABLED
#endif

#if IS_ENABLED(CONFIG_SECURITY_ABAC_RULES_ENC)
#define ABAC_RULES_ENC_ENABLED 1,
#else
#define ABAC_RULES_ENC_ENABLED
#endif

#if IS_ENABLED(CONFIG_SECURITY_ABAC_TREES)
#define ABAC_TREES_ENABLED 1,
#else
#define ABAC_TREES_ENABLED
#endif

#if IS_ENABLED(CONFIG_SECURITY_ABAC_TREES_ENC)
#define ABAC_TREES_ENC_ENABLED 1,
#else
#define ABAC_TREES_ENC_ENABLED
#endif
...
#define MAX_LSM_COUNT			\
	COUNT_LSMS(			\
		...
		IPE_ENABLED		\
		ABAC_RULES_ENABLED	\
		ABAC_RULES_ENC_ENABLED	\
		ABAC_TREES_ENABLED	\
		ABAC_TREES_ENC_ENABLED	\
		DABAC_RS_ENABLED)
